export const VALIDATION_MESSAGES = {
  ...
  GUIDE: {
    GET_ALL_ERROR:
      'Something went wrong while fetching all guides. Please try again later.',
    GET_DETAILS_BY_ID_ERROR:
      'Something went wrong while fetching details for guide with ID %s. Please try again later.',
    CREATE_NEW_ERROR: 'Failed to create new guide. Please try again later',
    EDIT_BY_ID_ERROR:
